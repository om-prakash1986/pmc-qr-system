                ...
                using (SqlCommand cmd = new SqlCommand(query, conn))
                {
                    ...
                    using (SqlDataReader sdr = cmd.ExecuteReader())
                    {
                        if (sdr.Read())
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine(string.Format("DEBUG TAX LOGIN: username={0}, password={1}, storedPassword={2}, isActive={3}", username, password, storedPassword, isActive));
    ...
    <style>
        ...
        * {
        ...
        .receipt-header {
            ...
            align-items: center;
            justify-content: space-between;
            border-bottom: 2px solid #0D3E73;
            padding-bottom: 20px;
            margin-bottom: 30px;
            position: relative;
            z-index: 1;
    ...
    <div id='receipt-container'>
        <div class='receipt-header'>
            ...
            <div class='receipt-title'>
                ...
                <p>Smart QR Card System - Municipal Tax Receipt</p>
            </div>
        ...
        <div class='receipt-info-grid'>
            <div class='info-box'>
                ...
                <div class='val' id='receipt-tx-id'>-</div>
            </div>
            <div class='info-box'>
                <label>Date & Time</label>
                <div class='val' id='receipt-date'>-</div>
            </div>
            <div class='info-box'>
                <label>Property ID (PID)</label>
                <div class='val' id='receipt-pid'>-</div>
            </div>
            <div class='info-box'>
                <label>Owner Name</label>
                <div class='val' id='receipt-owner'>-</div>
            </div>
            <div class='info-box' style='grid-column: span 2;'>
                <label>Property Address</label>
                <div class='val' id='receipt-address'>-</div>
            </div>
        </div>
        ...
        <table class='receipt-table'>
            ...
            <tbody>
                <tr>
                    <td>Municipal Property Tax Payment</td>
                    <td>Online Payment Gateway</td>
                    <td class='amount-col' id='receipt-amount'>-</td>
                </tr>
                <tr class='receipt-total'>
                    <td colspan='2' style='text-align: right;'>Total Amount Paid</td>
                    <td class='amount-col' id='receipt-total'>-</td>
                </tr>
            </tbody>
        </table>
        ...
        <div class='receipt-footer'>
            ...
            Powered by Patna Nagar Nigam Smart QR Card System.
        </div>

        <div class='receipt-actions'>
            <button onclick='window.print()'><i class='fas fa-print'></i> Print Receipt</button>
            <button class='btn-secondary' onclick='window.location.reload()'>Back to Dashboard</button>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('btn-pay-dues').onclick = function() {
            ...
            if (typeof Razorpay !== 'undefined') {
                var options = {
                    ...
                    ""handler"": async function (response) {
                        try {
                            ...
                            const mobileNo = document.getElementById('citizen-mobile').value || '9431881414';
                ...
                const pid = document.getElementById('detail-pid').innerText;
                const ownerName = document.getElementById('detail-owner').innerText;
                const paymentId = 'pay_sim_' + Math.floor(Math.random() * 1000000);
